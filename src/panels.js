...
function _panelUI(obj) {
    ...
    <div class="content">
        <div class="close" onclick="removePanel(this.parentElement.parentElement)"></div>
        <div class="info">
            ...
            <div class="detail">
                ...
                <div class="item">
                    <span>操作：</span>
                    <div id="switchDevice-${id}" class="operate info-panel ${operateOpenDevice}" onclick="switchDeviceState(\'${name}\', true)">
...
function createPanel(device) {
    console.log(`create ${device.name} panel`);
...
//                 <div class="item">
//                     <span>操作：</span>
//                     <div id="switchDevice-${id}" class="operate info-panel ${operateOpenDevice}" onclick="switchDeviceState2(this, '${id}')">
//                         <span class="circle ${circleOpenDevice}"></span>
//                     </div>
//                 </div>
//             </div>
...
function _classTableUI(courseData) {
    ...
    <table class="course-table">
        <tr><th>时间/日期</th><th>周一</th><th>周二</th><th>周三</th><th>周四</th><th>周五</th><th>周六</th><th>周日</th></tr>`;
    const timeSlots = ['08:00-08:45', '08:50-09:35', '09:50-10:35', '10:40-11:25', '11:30-12:15', '13:00-14:35', '14:45-15:30', '15:40-16:25', '16:35-17:20', '17:25-18:10', '18:30-19:15', '19:20-20:05', '20:10-20:55'];
...
function createClassTable(object) {
    // 首先从服务器获取课程表数据，然后将数据传入面板的HTML结构中
    fetch('http://124.221.115.182/api/classroom_table.php?classroom=3-317')
        ...
        .then(weeklyCourses => {
            ...
            object.addComponent(THING.DOM.CSS2DComponent, 'css_panel');
...
// }
// function switchDeviceState2(dom, objectId) { // NEED TEST
// 	// 1. 更新设备userData挂载的数据
...
function closePanel(dom, name) {
    const object = app.query(name)[0];
    
    reverseDeviceLocated(object);
    destroyPanel(dom);
